...
},{"./to-integer":"vc2B"}],"N9bW":[function(require,module,exports) {
"use strict";
...
},{}],"jqXd":[function(require,module,exports) {
'use strict';
...
},{}],"uxvn":[function(require,module,exports) {
'use strict';
...
exports.default = {
  ...
  methods: {
    refreshTime: function refreshTime() {
      var minutesAgo = (new Date() - this.time) / 1000 / 60;
      ...
      if (roundedMinutes == 0 || roundedMinutes === 1) {
        ...
        time = template(this.localeMap[this.locale].minutes, {
          time: roundedMinutes
        });
      } else if (hoursAgo < 8) {
        ...
        if (floorHours === 0 || floorHours === 1) {
          ...
          time = template(this.localeMap[this.locale].hours, {
            time: floorHours
          });
        }
      } else if (hoursAgo >= 24 && hoursAgo <= 36) {
        time = template(this.localeMap[this.locale].day, {
          time: 1
        });
      } else {
      ...
      if (typeof $f19e2f === 'function') {
        ...
        Object.assign($f19e2f, (function () {
          var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('h2',[_vm._v("vue-crono ⏰")]),_vm._v(" "),_c('div',{staticClass:"segment"},[_c('h3',[_vm._v("The current time is "+_vm._s(_vm.currentTime))]),_vm._v(" "),_vm._m(0),_vm._v(" "),(_vm.cronRunning)?_c('button',{on:{"click":_vm.stopTimer}},[_vm._v("Stop Timer")]):_vm._e(),_vm._v(" "),(!_vm.cronRunning)?_c('button',{on:{"click":_vm.startTimer}},[_vm._v("Start Timer")]):_vm._e()]),_vm._v(" "),_c('br'),_vm._v(" "),_c('br'),_vm._v(" "),_c('div',{staticClass:"segment"},[_c('h3',[_vm._v("Clean Time Display")]),_vm._v(" "),_vm._m(1),_vm._v(" "),_c('div',{staticClass:"time-table"},[_vm._v("\n            🕒"),_c('clean-time',{attrs:{"time":_vm.fiveMinutesAgo,"round":1}}),_vm._v(" Minutes ago (capped at 55 minutes)\n            "),_c('br'),_vm._v("\n            🕒"),_c('clean-time',{attrs:{"time":_vm.fiveHoursAgo}}),_vm._v(" Hours ago (capped at 8 hours)\n            "),_c('br'),_vm._v("\n            🕒"),_c('clean-time',{attrs:{"time":_vm.yesterday}}),_vm._v(" Approximately one Day ago\n            "),_c('br'),_vm._v("\n            🕒"),_c('clean-time',{attrs:{"time":_vm.tenDaysAgo}}),_vm._v(" Days ago (displays actual date in user's locale format)\n        ")],1),_vm._v(" "),_c('p',[_vm._v("You can also change the display strings")]),_vm._v(" "),_c('div',{staticClass:"time-table"},[_vm._v("\n            🕒"),_c('clean-time',{ref:"smallestTime",attrs:{"time":_vm.minuteAgo,"round":1,"locale-map":{ en: {
                      ...
                      day: '${time} day ago',
                      days: '${time} days ago'
                  } }}}),_vm._v(" 1 minute ago or less\n            "),_c('br'),_vm._v("\n            🕒"),_c('clean-time',{attrs:{"time":_vm.yesterday,"round":1,"locale-map":{ en: {
                      minute: 'just now',
                      minutes: '${time} minutes ago',
                      hour: '${time} hour ago',
                      hours: '${time} hours ago',
                      day: 'yesterday',
                      days: '${time} days ago'
                  } }}}),_vm._v(" Approximately one Day ago\n        ")],1)])])}
var staticRenderFns = [function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('p',[_vm._v("updated every 5 seconds by "),_c('pre',[_vm._v("cron: {  time: 5000, method: 'load'}")])])},function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('p',[_vm._v("Show users how long ago something occurred in a concise manner by binding a Date object to "),_c('pre',[_vm._v("<clean-time></clean-time>")]),_vm._v(" (times are set to update every minute)")])}]
...
},{"./app.vue":"hWNS"}],"JjiN":[function(require,module,exports) {
