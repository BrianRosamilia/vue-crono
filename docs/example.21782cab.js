...
var createTimer = function createTimer(cron) {
    ...
    this._cron[method].time = cron.time;
        ...
        mounted: function mounted() {
            ...
            this.$cron = {
                ...
                time: function time(method, _time) {
                    var elapsed = +Date() - _this2._cron[method].lastInvocation;
...
exports.default = {
    ...
    methods: {
        ...
        adjustTimer: function adjustTimer() {
            this.$cron.time('load', 10000);
        }
    },
    mounted: function mounted() {
        this.load();
    ...
    cron: {
      ...
      if (typeof $f19e2f === 'function') {
        ...
        Object.assign($f19e2f, (function () {
          var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('h2',[_vm._v("vue-crono ⏰")]),_vm._v(" "),_c('h3',[_vm._v("The current time is "+_vm._s(_vm.currentTime))]),_vm._v(" "),_c('p',[_vm._v("( updated every 5 seconds by cron )")]),_vm._v(" "),(_vm.cronRunning)?_c('button',{on:{"click":_vm.stopTimer}},[_vm._v("Stop Timer")]):_vm._e(),_vm._v(" "),(!_vm.cronRunning)?_c('button',{on:{"click":_vm.startTimer}},[_vm._v("Start Timer")]):_vm._e(),_vm._v(" "),_c('button',{on:{"click":_vm.adjustTimer}},[_vm._v("Change interval to 10 second updates")])])}
var staticRenderFns = []
...
//# sourceMappingURL=example.21782cab.map